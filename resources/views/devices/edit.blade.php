                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('devices.update', $device) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" class="block w-full rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-white @error('name') border-red-500 @enderror" value="{{ old('name', $device->name) }}" required>
                                    @error('name')
                                ...
                                <div>
                                    ...
                                    <input type="text" name="ip_address" id="ip_address" class="block w-full rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-white @error('ip_address') border-red-500 @enderror" value="{{ old('ip_address', $device->ip_address) }}" required>
                                    @error('ip_address')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="location" id="location" class="block w-full rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-white @error('location') border-red-500 @enderror" value="{{ old('location', $device->location) }}">
                                    @error('location')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="description" id="description" rows="3" class="block w-full rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-white @error('description') border-red-500 @enderror">{{ old('description', $device->description) }}</textarea>
                                    @error('description')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="flex items-center">
                                    <div class="flex items-center h-5">
                                        <input id="is_active" name="is_active" type="checkbox" value="1" class="focus:ring-blue-500 h-4 w-4 text-blue-600 rounded dark:bg-gray-700 dark:border-gray-600" {{ old('is_active', $device->is_active) ? 'checked' : '' }}>
                                    </div>
                        ...
                        <div class="mt-8 flex justify-end space-x-3">
                            <a href="{{ route('devices.index') }}" class="inline-flex items-center px-4 py-2 border shadow-sm text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600">
                                Batal
                            </a>
