<x-guest-layout>
    <div class=" flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 p-4">
        <div class="w-full max-w-md">
            <div class="text-center mb-10 animate-fade-in">
                <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 mb-4 shadow-lg">
            ...
            <div class="relative bg-white/70 backdrop-blur-lg rounded-2xl shadow-xl border border-white/30 p-8 transition-all duration-300 hover:shadow-2xl animate-slide-up">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-6 animate-fade-in-delay-100">
                        ...
                        <div class="relative">
                            ...
                            <x-text-input id="email" 
                                         class="block w-full pl-10 pr-3 py-3 rounded-lg border-gray-300 bg-white/50 focus:border-blue-500 focus:ring-blue-500 transition-all duration-200" 
                                         type="email" 
                                         name="email" 
                                         :value="old('email')" 
                                         required 
                    ...
                    <div class="animate-fade-in-delay-400">
                        <x-primary-button class="w-full py-3 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium rounded-lg shadow-lg transition-all duration-300 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                            {{ __('Sign In') }}
                        </x-primary-button>
                    </div>
                </form>
