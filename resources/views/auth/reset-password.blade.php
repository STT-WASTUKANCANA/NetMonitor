<x-guest-layout>
    <div class=" flex items-center justify-center bg-gradient-to-br from-rose-50 via-white to-pink-50 p-4">
        <div class="w-full max-w-md">
            <div class="text-center mb-10 animate-fade-in">
                ...
                <h1 class="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-rose-600 to-pink-600">
                    NetMonitor
                </h1>
                <h2 class="mt-4 text-2xl font-semibold text-gray-800">Set new password</h2>
            ...
            <div class="relative bg-white/70 backdrop-blur-lg rounded-2xl shadow-xl border border-white/30 p-8 transition-all duration-300 hover:shadow-2xl animate-slide-up">
                <form method="POST" action="{{ route('password.store') }}">
                    ...
                    <div class="mb-6 animate-fade-in-delay-100">
                        ...
                        <div class="relative">
                            ...
                            <x-text-input id="email" 
                                         class="block w-full pl-10 pr-3 py-3 rounded-lg border-gray-300 bg-white/50 focus:border-rose-500 focus:ring-rose-500 transition-all duration-200" 
                                         type="email" 
                                         name="email" 
                    ...
                    <div class="animate-fade-in-delay-400">
                        <x-primary-button class="w-full py-3 px-4 bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-700 hover:to-pink-700 text-white font-medium rounded-lg shadow-lg transition-all duration-300 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2">
                            {{ __('Reset Password') }}
                        </x-primary-button>
                    </div>
                </form>
            ...
            <div class="mt-6 text-center animate-fade-in-delay-500">
                <p class="text-gray-600">
                    <a href="{{ route('login') }}" class="font-medium text-rose-600 hover:text-rose-700 transition-colors duration-200">
                        Back to sign in
                    </a>
                </p>
            </div>
