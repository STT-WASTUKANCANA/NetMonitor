...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Alert>|Alert active()
     * @method static \Illuminate\Database\Eloquent\Builder<Alert>|Alert resolved()
     ...
     * @property mixed $hierarchy_level
     * @property mixed $type
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Device>|Device whereIpAddress($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Device>|Device whereType($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Device>|Device whereHierarchyLevel($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Device>|Device whereParentId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Device>|Device whereLocation($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Device>|Device whereDescription($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Device>|Device whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Device>|Device whereLastCheckedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Device>|Device whereIsActive($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Device>|Device active()
     * @method static \Illuminate\Database\Eloquent\Builder<Device>|Device utama()
     * @method static \Illuminate\Database\Eloquent\Builder<Device>|Device sub()
     * @method static \Illuminate\Database\Eloquent\Builder<Device>|Device device()
     ...
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property boolean $is_manual_check
     * @property string|null $message
     * @property \Illuminate\Support\Carbon $checked_at
     * @property mixed $status
     * @property decimal:2|null $response_time
     * @property mixed $device_id
     * @property int $id
     ...
     * @property \Illuminate\Support\Carbon $checked_at
     * @property mixed $status
     * @property decimal:2 $response_time
     * @property mixed $device_id
     * @property int $id
     * @property-read mixed $checked_formatted
     * @property-read mixed $checked_short
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Log>|Log whereDeviceId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Log>|Log whereResponseTime($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Log>|Log whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Log>|Log whereCheckedAt($value)
